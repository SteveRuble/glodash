...
[![GitHub Release](https://img.shields.io/github/v/release/SteveRuble/glodash)](https://github.com/SteveRuble/glodash/releases)
[![Go Reference](https://pkg.go.dev/badge/github.com/SteveRuble/glodash.svg)](https://pkg.go.dev/github.com/SteveRuble/glodash)
[![go.mod](https://img.shields.io/github/go-mod/go-version/SteveRuble/glodash)](go.mod)
[![LICENSE](https://img.shields.io/github/license/SteveRuble/glodash)](LICENSE)
[![Build Status](https://img.shields.io/github/workflow/status/SteveRuble/glodash/build)](https://github.com/SteveRuble/glodash/actions?query=workflow%3Abuild+branch%3Amain)
[![Go Report Card](https://goreportcard.com/badge/github.com/SteveRuble/glodash)](https://goreportcard.com/report/github.com/SteveRuble/glodash)
[![Codecov](https://codecov.io/gh/SteveRuble/glodash/branch/main/graph/badge.svg)](https://codecov.io/gh/SteveRuble/glodash)
...
1. Replace all occurences of `SteveRuble/glodash` to `your_org/repo_name` in all files.
